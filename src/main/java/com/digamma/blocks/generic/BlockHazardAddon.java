...
public class BlockHazardAddon extends Block implements IItemHazard {
    ...
    public BlockHazardAddon(Material mat, String s) {
        super(mat);
    ...
    public BlockHazardAddon(String s) {
        this(Material.IRON, s);
    }

    public BlockHazardAddon(Material mat, SoundType type, String s) {
        this(mat, s);
        setSoundType(type);
    }

    public BlockHazardAddon(SoundType type, String s) {
        this(Material.IRON, s);
        setSoundType(type);
    }

    public BlockHazardAddon setDisplayEffect(ExtDisplayEffect extEffect) {
    ...
    public BlockHazardAddon makeBeaconable() {
        this.beaconable = true;
        return this;
    }

    public BlockHazardAddon addRad3d(int rad3d) {
        this.rad3d = rad3d;
        return this;
    }
